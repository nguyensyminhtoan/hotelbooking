...
<h2>Hotel Booking Web</h2>

![image](https://github.com/nguyensyminhtoan/hotelbooking/assets/126958335/88cb4c8b-63d8-4dbf-8a0e-235c3b11fa0e)
...
<ul>
    <li>(Client) Account authentication function</li>
    <li>(Client) Search for suitable hotels</li>
    <li>(Client) Displays specific information about a hotel</li>
    <li>(Client) Create an interface to book a hotel</li>
    <li>(Client) Displays performed transactions</li>
    <li>(Admin) Authenticate and display Admin Dashboard</li>
    <li>(Admin) View list / Add / Delete hotels</li>
    <li>(Admin) View list / Add / Delete room</li>
    <li>((Admin) View all transactions</li>
    <li>(Admin) Edit hotel and room information</li>
  </ul>
